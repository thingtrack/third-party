...
/**
 * Contants for MySQL data source factory registration.
 * 
 * @author carlos
 */
public class DataSourceFactoryConstants {
	...
	public static final String MYSQL_CLIENT_DRIVER_CLASS = "com.mysql.jdbc.Driver";

	// Register all MySQL factory services under this driver name

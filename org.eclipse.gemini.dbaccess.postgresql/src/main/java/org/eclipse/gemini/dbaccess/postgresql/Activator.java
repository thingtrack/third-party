...
/**
 * Creates a {@link DataSourceFactory} for each of the available PostgreSQL JDBC
 * driver type.
 * 
 * @author carlos
 * 
...
public class Activator implements BundleActivator {
	...
	public void start(BundleContext context) throws Exception {
		...
		System.out.println("Gemini DBAccess PostgreSQL starting");

		Hashtable<String, String> props = new Hashtable<String, String>();
		props.put(DataSourceFactory.OSGI_JDBC_DRIVER_NAME,
				DataSourceFactoryConstants.POSTGRESQL_DRIVER_NAME);
		...
		props.put(DataSourceFactory.OSGI_JDBC_DRIVER_CLASS,
				DataSourceFactoryConstants.POSTGRESQL_CLIENT_DRIVER_CLASS);
